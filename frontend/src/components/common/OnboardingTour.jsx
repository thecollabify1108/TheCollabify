                    ...
                    >
                        <div className="bg-dark-800 border border-dark-700 rounded-2xl overflow-hidden shadow-2xl">
                            ...
                            <div className="p-6">
                                ...
                                >
                                    <h3 className="text-xl font-bold text-dark-100 mb-2 text-center">
                                        {step.title}
                                    </h3>
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <motion.button
                                        ...
                                        whileTap={{ scale: 0.95 }}
                                        onClick={handleNext}
                                        className={`flex items-center gap-2 px-6 py-2 rounded-lg bg-gradient-to-r ${step.color} text-white font-medium`}
                                    >
