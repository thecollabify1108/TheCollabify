...
const SellerDashboard = () => {
    ...
    const [showGuide, setShowGuide] = useState(true);
        // UI/UX refactor: Remove floating AI button, toolkit, 'What are you trying to do today?' section, lock unfinished sections, make cards expandable, fix navigation, move insights/ROI, remove profile button, switch greeting.
        return (
            <DashboardLayout
                user={user}
                activeTab={activeTab}
            ...
            >
                ...
                <AnimatePresence mode="wait">
                    ...
                    {/* Team Management Tab (locked if unfinished) */}
                    {activeTab === 'team' && (
                        <motion.div
                            key="team"
                            initial={{ opacity: 0, x: 20 }}
                            ...
                            exit={{ opacity: 0, x: -20 }}
                        >
                            {/* Lock unfinished section */}
                            <div className="bg-dark-800/60 border border-dark-700/50 rounded-xl p-6 flex flex-col items-center justify-center">
                    ...
                    {activeTab === 'dashboard' && (
                        ...
                        >
                            {/* 1. Hero Section (switch greeting, remove profile button) */}
                            <DashboardHero
                            ...
                            {/* Brand Insights moved to stats section */}
                            <div className="mt-4">
                                <BrandInsightCards />
                            </div>
                            ...
                            {/* 4. Active Campaigns List (Modernized, expandable cards) */}
                ...
                {/* Intelligence Copilot Panel removed for launch */}
                {/* <AIAssistantPanel
                    campaign={selectedRequest}
                    onUse={(content) => {
