                ...
                < section className="py-24 px-4 relative bg-dark-900 border-t border-dark-800/50" >
                    <div className="max-w-5xl mx-auto">
                        <div className="text-center mb-16">
                            ...
                            <motion.h2
                                className="text-3xl md:text-5xl font-bold mb-6 text-dark-100"
                                initial={{ opacity: 0, y: 20 }}
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            ...
                            >
                                <h3 className="text-2xl font-bold text-dark-100 mb-6">The 3 Core Signals</h3>
                                <div className="space-y-6">
                                    <div className="flex gap-4">
                                        ...
                                        <div>
                                            <h4 className="font-bold text-dark-100">Deep Relevance</h4>
                                            <p className="text-dark-400 text-sm">We don't just match keywords. We analyze content style, tone, and audience values to find brand-safe fits.</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-4">
                                        ...
                                        <div>
                                            <h4 className="font-bold text-dark-100">Performance History</h4>
                                            <p className="text-dark-400 text-sm">Creators with a track record of on-time delivery and high engagement get priority visibility.</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-4">
                                        ...
                                        <div>
                                            <h4 className="font-bold text-dark-100">Audience Authenticity</h4>
                                            <p className="text-dark-400 text-sm">We flag suspicious follower spikes instantly. Quality always beats quantity.</p>
                                        </div>
                                    </div>
                                </div>
                            </motion.div>
